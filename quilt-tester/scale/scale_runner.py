...
PREBOOT_SPEC = "./bench_specs/preboot-scale.spec"
BOOT_SPEC = "./bench_specs/scale.spec"
FULL_MESH_BOOT_SPEC = "./bench_specs/scale-full-mesh.spec"
POSTBOOT_SPEC = "./bench_specs/postboot-scale.spec"
FULL_MESH_POST_SPEC = "./bench_specs/post-scale-full-mesh.spec"
